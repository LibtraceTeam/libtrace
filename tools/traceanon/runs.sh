...
make && ./traceanon -sd -c foobarbazaaaaaaaaaaaaaaaaaaaaaaaaaaaa ../../../example/trace/radius-openli.erf.gz -R saltysalt -r 203.114.128.111:1645:1646 erf:../../../example/trace/example.erf