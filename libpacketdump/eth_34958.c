...
static void decode_eap_request(char *packet, int len)
{
	int v;
	POPBYTE(v);
...
static void decode_eap(char *packet, int len)
{
	int v;
	POPWORD(v);
...
static void decode_eapol_start(char *packet, int len)
{
	int v;
	POPWORD(v);
	printf(" 802.1x: Length: %d\n",v);
...
static void decode_eapol_logoff(char *packet, int len)
{
	int v;
	POPWORD(v);
	printf(" 802.1x: Length: %d\n",v);
...
static void decode_eapol_key(char *packet, int len)
{
	int v;
	POPWORD(v);
	printf(" 802.1x: Length: %d\n",v);
...
static void decode_eapol_encapsulated_asf_alert(char *packet, int len)
{
	int v;
	POPWORD(v);
	printf(" 802.1x: Length: %d\n",v);
