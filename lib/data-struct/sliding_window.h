...
/* void libtrace_slidingwindow_write(libtrace_slidingwindow_t * sw, uint64_t
 * number, void* value); */
...
int libtrace_slidingwindow_try_swrite(libtrace_slidingwindow_t * sw, void*
value); int libtrace_slidingwindow_try_swrite_bl(libtrace_slidingwindow_t * sw,
void* value);
*/
/*
void * libtrace_slidingwindow_sread(libtrace_slidingwindow_t *sw);
int libtrace_slidingwindow_try_sread(libtrace_slidingwindow_t *sw, void **
value); int libtrace_slidingwindow_try_sread_bl(libtrace_slidingwindow_t *sw,
void ** value);
*/
#endif
